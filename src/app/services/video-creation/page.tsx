              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  {highlights.map(({ label, icon: Icon }, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-3 rounded-xl border border-[#E2E8F0] bg-white px-4 py-3.5 hover:border-[#DC2626]/30 transition-colors duration-300"
                    >
                      <div className="shrink-0 w-8 h-8 rounded-lg bg-[#DC2626]/[0.08] flex items-center justify-center">
