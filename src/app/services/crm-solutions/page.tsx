          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6">
              {highlights.map(({ label, icon: Icon }, i) => (
                <div
                  key={i}
                  className="h-full min-h-[92px] flex items-center gap-4 rounded-2xl border border-[#E2E8F0] bg-white px-5 py-4 hover:border-[#D97706]/30 hover:shadow-sm transition-all duration-300"
                >
                  <div className="shrink-0 w-10 h-10 rounded-xl bg-[#D97706]/[0.08] flex items-center justify-center">
