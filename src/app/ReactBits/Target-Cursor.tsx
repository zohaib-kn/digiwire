...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Top-left corner */}
      <div
        className="target-cursor-corner absolute top-1/2 left-1/2 w-4 h-4 border-[2px] border-dashed border-white -translate-x-[150%] -translate-y-[150%] border-r-0 border-b-0"
        style={{ willChange: 'transform' }}
      />
      {/* Top-right corner */}
      <div
        className="target-cursor-corner absolute top-1/2 left-1/2 w-4 h-4 border-[2px] border-dashed border-white translate-x-1/2 -translate-y-[150%] border-l-0 border-b-0"
        style={{ willChange: 'transform' }}
      />
      {/* Bottom-right corner */}
      <div
        className="target-cursor-corner absolute top-1/2 left-1/2 w-4 h-4 border-[2px] border-dashed border-white translate-x-1/2 translate-y-1/2 border-l-0 border-t-0"
        style={{ willChange: 'transform' }}
      />
      {/* Bottom-left corner */}
      <div
        className="target-cursor-corner absolute top-1/2 left-1/2 w-4 h-4 border-[2px] border-dashed border-white -translate-x-[150%] translate-y-1/2 border-r-0 border-t-0"
        style={{ willChange: 'transform' }}
      />
    </div>
  );
