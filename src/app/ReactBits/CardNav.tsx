...
const CardNav: React.FC<CardNavProps> = ({
  ...
  return (
    <div className={`card-nav-container absolute left-1/2 -translate-x-1/2 w-[90%] max-w-[800px] z-[99] top-[1.2em] md:top-[2em] ${className}`}>
      <nav
        ref={navRef}
        className={`card-nav ${isExpanded ? 'open' : ''} block h-[60px] p-0 rounded-xl border border-white/10 backdrop-blur-md shadow-md relative overflow-hidden will-change-[height]`}
        style={{
        ...
        >
          {(items || []).map((item, idx) => (
            ...
            >
              ...
              <div className="nav-card-links mt-auto flex flex-col gap-[2px] max-h-[180px] overflow-y-auto pr-1 [scrollbar-width:thin] [scrollbar-color:rgba(255,255,255,0.15)_transparent] [&::-webkit-scrollbar]:w-[3px] [&::-webkit-scrollbar-track]:bg-transparent [&::-webkit-scrollbar-thumb]:bg-white/15 [&::-webkit-scrollbar-thumb]:rounded-full">
